...
beta1 = 0.7 #------------------------------ The decay rate 1.
beta2 = 0.88 #---------------------------- The decay rate 2.
learning_rate = (beta1/n_input) #---------- The learning rate.
stop_learning = 1.20 #-------------------- The stop learning point.
...
while epoch == 0 or new_cost >= stop_learning:
    ...
    if epoch % n_diplay == 0 or new_cost <= stop_learning:
        ...
        #Spectral_Clustering
        idx_cos = SpectralClustering(n_clusters=n_clusters).fit(ae_codes_cos).labels_
